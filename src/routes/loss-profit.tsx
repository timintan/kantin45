...
export const Route = createFileRoute("/loss-profit")({
  component: LossProfit,
});
              ...
              <table className="w-full text-[13px]">
                ...
                <tbody>
                  {!loaded ? (
                    ...
                    <tr><td colSpan={8} className="text-center text-primary text-sm p-5">✅ Tidak ada barang yang terdeteksi hilang</td></tr>
                  ) : rows.map((r, i) => (
                    <tr key={i} className="bg-destructive/5 border-b">
                      ...
                      <td className="p-2.5 text-center text-destructive font-bold">{r.hilang}</td>
