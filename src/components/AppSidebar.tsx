...
const items = [
  { title: 'Kasir', url: '/', icon: ShoppingCart },
    ...
    <Sidebar collapsible="icon" className="border-r-0">
      <SidebarContent className="bg-sidebar">
        <div className="flex items-center gap-3 px-4 py-5">
          ...
          {!collapsed && (
            <div>
              <div className="text-primary font-bold text-base leading-tight">Kantin 45</div>
              <div className="text-primary/80 text-xs font-medium">SMPN 45 Semarang</div>
            </div>
          )}
        </div>
